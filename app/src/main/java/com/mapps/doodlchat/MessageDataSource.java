...
public class MessageDataSource {
    private static final Firebase sRef = new Firebase("https://doodlchat.firebaseio.com/");
    ...
    public static void saveMessage(Message message, String convoId){
        ...
        sRef.child("users").child(firebaseAuth.getCurrentUser().getEmail()).child(convoId).child(key).setValue(msg);
    }
